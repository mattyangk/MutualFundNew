...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<h1 class="page-header">View Customer Transaction History</h1>
	...
	<table data-height="600" data-sort-name="name" data-sort-order="desc"
		...
		<thead>
			<tr>
                <th data-align="center" data-sortable="true">Customer</th>
		...
		<tbody>
			...
			<c:forEach var="transaction" items="${allTransactionsHistory}">
				<tr>
